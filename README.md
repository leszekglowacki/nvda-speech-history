...
* You can review the characters in the currently selected history item using Control+Shift+F11 and Control+Shift+F12, and copy the currently selected character using Control+F12.
